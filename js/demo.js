(function() {
    ...
    var textOptions = {
        ...
        fontSize: function() { return windowWidth > 720 ? 50 : 20; },
        padding: '15 20 10 20',
        angle: -45,
        piecesSpacing: 2,
    ...
    var numberOptions = {
        color: 'white',
        backgroundColor: '#5104ab',
        fontSize: function() { return windowWidth > 720 ? 30 : 13; },
        padding: function() { return windowWidth > 720 ? '18 35 10 38' : '18 25 10 40'; },
        angle: 0,
        piecesSpacing: 2,
    ...
    for (var i = 0; i < slidesLength; i++) {
        ...
        items.push({type: 'text', value: years[i], options: numberOptions});
        // Save indexes
